import { courseImg } from './images'

const courses = [
  {
    id: 'xMHCZl',
    category: 'python',
    image: courseImg.python5,
  ...
  },
  {
    id: 'VwkN_o',
    category: 'python',
    image: courseImg.python2,
    name: 'Python For Beginners : This course is meant for absolute beginners in programming or in python.',
    description:
  ...
  },
  {
    id: 'xJB-WU',
    category: 'python',
    image: courseImg.python1,
    name: 'Python Beyond the Basics - Object-Oriented Programming',
    description:
  ...
  },
  {
    id: 'e_0hBc',
    category: 'web development',
    image: courseImg.webDev4,
    name: 'Running a Web Development Business: The Complete Guide',
    description:
      'Learn how to star and grow a successful web development business. Get up & running and making sales in under a week.',
    rating: 1577,
    star: 4.8,
    students: 33100,
  ...
  },
  {
    id: 'z9dxdw',
    category: 'web development',
    image: courseImg.webDev5,
    name: 'Ultimate Web Designer & Web Developer Course',
    description:
  ...
  },
  {
    id: 'xxxbMD',
    category: 'aws',
    image: courseImg.aws1,
    name: 'Amazon Web Services (AWS) Certified 2022 - 4 Certifications!',
    description:
  ...
  },
  {
    ...
    content: [
      'Getting stared with the course',
  ...
  },
  {
    ...
    discounted: 16.99,
    learnItems: [
      'Part one – everything you need for a fast-track star, including your first article',
